...
class EEPositionLogger(Node):
    def __init__(self):
        ...
        self.declare_parameter("topic_name", "/frankaRight/ee_pose")
        ...
        self.save_dir = "/docker_volume/ros2_ws/src/joint_state_collection/ee_position_data"
        ...
        self.get_logger().info("[EE Pose Logger] Ready. Press '1' to start, '2' to stop logging.")
    ...
    def start_logging(self):
        if not self.recording:
            ...
            prefix = f"{date_str}_"
            suffix_full = "ee_pose_right_full.txt"
            suffix_synced = "ee_pose_right_synced.txt"
            ...
            base_filename = f"{date_str}_{next_index}_ee_pose_right"
            ...
            self.recording = True
            self.get_logger().info(f"Started EE pose logging: {base_filename}")
    ...
    def stop_logging(self):
        if self.recording:
            ...
            self.recording = False
            self.get_logger().info("Stopped EE pose logging.")
