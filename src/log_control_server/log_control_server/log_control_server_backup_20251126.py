...
from .ee_velocity_cmd_listener import EEVelocityLogger
from .joint_states_listener import JointStateLogger
from .joint_velocity_cmd_listener import JointVelocityLogger
...
def main(args=None):
    ...
    joint_vel_logger = JointVelocityLogger()

    listeners = [ee_pos_logger, ee_vel_logger, joint_state_logger, joint_vel_logger]
